...
import com.nuowei.smarthome.activity.ActivityLimitSettingActivity;
...
import com.nuowei.smarthome.activity.FreshAirMchineActivity;
import com.nuowei.smarthome.activity.HistoricalDataActivity;
...
//                        MyUtil.showNoDialog(getActivity());
                        startActivity(new Intent(getActivity(), ActivityLimitSettingActivity.class));
                        break;
                    case 3:
