...
public class MyApplication extends LitePalApplication implements XlinkNetListener {
    ...
    public final static String APPID="f5aaef082e9f6fcb4f23d201920323e5";
    public final static String APPToken="10e44afd1467c139151b013e98f475025c4ce5acbf6d6775ea3f8fa2d6de6c4a";
    //前两位是客户APP唯一编号(00.00 由技威分配),后两位是APP版本号(客户自定义),此参数不可省略
    public final static String APPVersion="04.94.00.01";
