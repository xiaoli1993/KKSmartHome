package com.nuowei.smarthome.appkit.view;
...
public class RoundProgressBar extends View {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		textColor = mTypedArray.getColor(R.styleable.RoundProgressBar_RtextColor, Color.BLACK);
		textSize = mTypedArray.getDimension(R.styleable.RoundProgressBar_RtextSize, 35);
