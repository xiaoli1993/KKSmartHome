package com.nuowei.smarthome.view.circleprogresslibrary;
...
public class CircleProgress extends View {
    ...
    protected void initVar(Context context, AttributeSet attrs) {
        ...
        bgPaintColor = ta.getColor(R.styleable.CircleProgress_CbgColor, Color.GRAY);
        foreStartColor = ta.getColor(R.styleable.CircleProgress_foreStartColor, Color.BLUE);
        foreMiddleColor = ta.getColor(R.styleable.CircleProgress_foreMiddleColor,Color.BLUE);
...
//            LinearGradient gradient = new LinearGradient(0, 0, mWidth, mHeight, foreEndColcor, foreStartColor, Shader.TileMode.CLAMP);
            LinearGradient gradient = new LinearGradient(0, 0, mWidth, mHeight, new int[]{foreEndColcor, foreMiddleColor, foreStartColor},new float[]{0 , 0.5f, 1.0f}, Shader.TileMode.CLAMP);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mPaintRectF, 45, maxProgress, isSolid, bgPaint);
        canvas.drawArc(mPaintRectF, 45, currProgress, isSolid, forePaint);
    }
